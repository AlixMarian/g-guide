  ...
  return (
    ...
    >
      ...
      <Form>
        ...
        <div className="d-flex align-items-start text-muted small" style={{marginTop: '1rem'}}>
          <i className="bi bi-info-circle me-1 text-danger"></i>
          <span className='text-justify fst-italic' style={{fontSize: '12px'}}>Generate churches to view suggested stops along the route to the end location.</span>
        </div>
        ...
        <div style={{marginTop: '18rem'}}>
          <div className="d-flex align-items-start text-muted small">
            ...
            <span className='text-justify fst-italic' style={{fontSize: '12px'}}>Please note that the generated churches are suggested options and may not reflect the exact route you choose to take. <br></br>The decision is entirely yours.</span>
          </div>
        </div>
      </Form>
    </div>
